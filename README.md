...
| First-class support for staged golden tests                                               | ✔️       | ?                                                            | ?                                                                |
...
| Pretty printing counterexample output                                      | ✔️       | ✔️                                                           | [Lib](https://hackage.haskell.org/package/tasty-hedgehog)        |
...
| Randomised execution order by default                                                     | ✔️       | C                                                           | C                                                                |
| Deterministic randomness for randomised execution                                         | ✔️       | ✔️                                                           | C                                                                |
| Deterministic randomness for randomised execution order by default                        | ✔️       | C                                                           | C                                                                |
| Deterministic randomness                                                                  | ✔️       | ✔️                                                           | ✔️                                                                |
| Deterministic randomness by default                                                       | ✔️       | C                                                           | ✖️                                                                |
...
| A way to rerun only failing tests from previous run (`--skip-passed`)                     | ✔️       | ✔️                                                           | ?                                                                |
