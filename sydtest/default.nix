...
, filepath, lib, MonadRandom, mtl, opt-env-conf, opt-env-conf-test
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    envparse fast-myers-diff filepath MonadRandom mtl opt-env-conf path
  ...
  testHaskellDepends = [
    ...
    QuickCheck random safe-coloured-text stm text vector
  ];
